const SectionSix = () => {
    ...
    return (
        <div className="w-full h-[165vh] sm:h-[118vh] md:h-screen bg-[#EEEEEE] relative overflow-hidden">
            ...
            <div className="text-center text-[6vw] sm:text-[3vw] md:text-[2.3vw] pt-[4vw]">
            ...
            <div className="w-full h-[50vh] mt-[4vw] p-[7vw] py-0 flex flex-wrap items-center justify-between gap-4 md:gap-0">
