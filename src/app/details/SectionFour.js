        ...
        <div className="w-full md:h-screen bg-[#EEEEEE] relative overflow-hidden flex flex-col-reverse items-center md:items-start md:flex-row">
            ...
            <div ref={leftRef} className="w-full md:w-[50%] h-full pt-[10vw] ps-[4vw] z-10">
                ...
                <div className="w-[90%] my-[5vw] sm:my-[3vw] md:my-0 flex flex-wrap gap-4">
                    <ul className="list-disc text-[#4D4987] px-2 py-[1.6vw] sm:py-[.7vw] font-semibold text-[4.2vw] sm:text-[2vw] md:text-[1.4vw] ps-[7.6vw] sm:ps-[3vw] md:ps-[2.5vw] w-full sm:w-[48%] bg-white rounded border-l-2 border-[#4D4987] hover:bg-[#4C4886] hover:text-white transition-all duration-200 ease-in-out cursor-pointer"><li>Protect Your Business</li></ul>
                    <ul className="list-disc text-[#4D4987] px-2 py-[1.6vw] sm:py-[.7vw] font-semibold text-[4.2vw] sm:text-[2vw] md:text-[1.4vw] ps-[7.6vw] sm:ps-[3vw] md:ps-[2.5vw] w-full sm:w-[48%] bg-white rounded border-l-2 border-[#4D4987] hover:bg-[#4C4886] hover:text-white transition-all duration-200 ease-in-out cursor-pointer"><li>Network Security</li></ul>
                    <ul className="list-disc text-[#4D4987] px-2 py-[1.6vw] sm:py-[.7vw] font-semibold text-[4.2vw] sm:text-[2vw] md:text-[1.4vw] ps-[7.6vw] sm:ps-[3vw] md:ps-[2.5vw] w-full sm:w-[48%] bg-white rounded border-l-2 border-[#4D4987] hover:bg-[#4C4886] hover:text-white transition-all duration-200 ease-in-out cursor-pointer"><li>Data Security</li></ul>
