...
const SectionThree = () => {
    ...
    return(
        <div className="w-full h-[464vh] sm:h-[280vh] md:h-[340vh] bg-[#0A131C] relative">
            <div className="image w-full sm:w-[60vw] h-[40vh] absolute top-[10vw] p-4 sm:p-0 left-0 sm:left-[5vw] text-white">
                <img src="/img/ServicesDetailPage/SectionThree/image01.png" className="border-1 border-[#423D4C] rounded-lg" />
                ...
                <div className="w-full sm:w-[92%] mt-5 sm:flex gap-5">
                    <img src="/img/ServicesDetailPage/SectionThree/image02.png" className="w-full sm:w-[50%] border-1 border-[#423D4C] rounded" />
                    <img src="/img/ServicesDetailPage/SectionThree/image03.png" className="w-full mt-2 sm:mt-0 sm:w-[50%] border-1 border-[#423D4C] rounded-lg" />
                </div>
            ...
            <div className="ListOfServices text-white w-[90%] sm:w-[28vw] md:w-[32vw] border-1 border-[#423D4C] absolute top-[89%] sm:top-[90vw] md:top-[46vw] right-[5vw] p-4 rounded-lg">
                ...
                <div className="w-[100%] h-[10%] bg-[#042A48] mt-8 rounded p-2 flex items-center gap-5">
                    <img src="/img/ServicesDetailPage/SectionThree/servicerepo.png" className="w-[4vw] md:w-[8%]" />
            ...
            <div className="ListOfServices text-white w-[90%] sm:w-[28%] md:w-[32vw] border-1 border-[#423D4C] absolute top-[97%] sm:top-[142vw] md:top-[70vw] right-[5vw] p-4 rounded-lg">
                ...
                <div className="w-[100%] mt-2 md:mt-8 rounded flex flex-wrap items-center justify-between gap-2 md:gap-5">
                    <img src="/img/ServicesDetailPage/SectionThree/facebook.png" className="w-[10vw] sm:w-[3.6vw] md:w-[5vw]" />
                    <img src="/img/ServicesDetailPage/SectionThree/youtube.png" className="w-[10vw] sm:w-[3.6vw] md:w-[5vw]" />
                    <img src="/img/ServicesDetailPage/SectionThree/instagram.png" className="w-[10vw] sm:w-[3.6vw] md:w-[5vw]" />
                    <img src="/img/ServicesDetailPage/SectionThree/twitter.png" className="w-[10vw] sm:w-[3.6vw] md:w-[5vw]" />
                </div>
            </div>
        </div>
    );
